    ...
    return (
        <div className="flex flex-col lg:flex-row lg:relative max-w-[1200px] mx-auto mt-32 mb-14 lg:mb-52 p-5">
            ...
            <div className="lg:absolute lg:z-0 lg:bottom-[-100px] lg:left-[400px]">
                ...
                <div className="flex gap-4  md:gap-10 justify-center rounded-2xl items-center mt-14 md:w-[550px] md:h-[200px] bg-gradient-to-r from-orange-400 via-yellow-400 to-yellow-300 shadow-md p-8 md:p-0 mx-auto lg:mx-0">
