    ...
    return (
        <div className="relative max-h-screen">
            ...
            <div className="absolute left-[500px] top-[470px]">
                ...
                <Link to="/" className="flex items-center text-lg font-bold text-violet-500 pt-10 font-pacifico  hover:text-violet-700"><FaHandPointLeft className="inline text-3xl mr-2"></FaHandPointLeft>Back to Home</Link>
            </div>
        </div>
    );
};
